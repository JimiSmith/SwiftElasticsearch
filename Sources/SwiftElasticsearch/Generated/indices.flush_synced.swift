extension Request {
     ...
     */
    public static func indices_flush_synced(method: HttpMethod = .POST) -> Request {
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_flush_synced(index: [String], method: HttpMethod = .POST) -> Request {
        assert(method == .POST || method == .GET)
