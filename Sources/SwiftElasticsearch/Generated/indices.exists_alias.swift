extension Request {
     ...
     */
    public static func indicesExistsAlias(name: [String], method: HttpMethod = .HEAD) -> Request {
        assert(method == .HEAD)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesExistsAlias(index: [String], name: [String], method: HttpMethod = .HEAD) -> Request {
        assert(method == .HEAD)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesExistsAlias(index: [String], method: HttpMethod = .HEAD) -> Request {
        assert(method == .HEAD)
