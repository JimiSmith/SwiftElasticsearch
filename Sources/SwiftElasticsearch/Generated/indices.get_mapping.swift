extension Request {
     ...
     */
    public static func indicesGetMapping(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_mapping"
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetMapping(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetMapping(type: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetMapping(index: [String], type: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
