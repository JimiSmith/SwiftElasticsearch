extension Request {
     ...
     */
    public static func count_percolate(index: String, type: String, method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func count_percolate(index: String, type: String, method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index)/\(type)/_percolate/count"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func count_percolate(index: String, type: String, id: String, method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func count_percolate(index: String, type: String, id: String, method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index)/\(type)/\(id)/_percolate/count"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
