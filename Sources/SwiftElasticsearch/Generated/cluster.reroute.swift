extension Request {
     ...
     */
    public static func cluster_reroute(method: HttpMethod = .POST, body: ElasticsearchBody?) -> Request {
        assert(method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func cluster_reroute(method: HttpMethod = .POST, body: [String : Any]?) -> Request {
        assert(method == .POST)
        let url = "/_cluster/reroute"
