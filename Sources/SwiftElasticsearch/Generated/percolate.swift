extension Request {
     ...
     * - parameter index: The index of the document being percolated.
     * - parameter method: The http method used to execute the request
     * - parameter body: The body to be sent with the request
     */
    public static func percolate(index: String, type: String, method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func percolate(index: String, type: String, method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index)/\(type)/_percolate"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func percolate(index: String, type: String, id: String, method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func percolate(index: String, type: String, id: String, method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index)/\(type)/\(id)/_percolate"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
