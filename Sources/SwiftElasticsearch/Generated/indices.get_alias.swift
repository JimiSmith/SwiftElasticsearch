extension Request {
     ...
     */
    public static func indicesGetAlias(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_alias"
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetAlias(name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetAlias(index: [String], name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesGetAlias(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
