extension Request {
     ...
     */
    public static func clusterPutSettings(method: HttpMethod = .PUT, body: ElasticsearchBody?) -> Request {
        assert(method == .PUT)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func clusterPutSettings(method: HttpMethod = .PUT, body: [String : Any]?) -> Request {
        assert(method == .PUT)
        let url = "/_cluster/settings"
