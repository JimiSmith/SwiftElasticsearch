extension Request {
     ...
     */
    public static func search_shards(method: HttpMethod = .GET) -> Request {
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func search_shards(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func search_shards(index: [String], type: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET || method == .POST)
