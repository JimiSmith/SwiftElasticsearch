extension Request {
     ...
     */
    public static func fieldStats(method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func fieldStats(method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/_field_stats"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func fieldStats(index: [String], method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func fieldStats(index: [String], method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index.joined(separator: ","))/_field_stats"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
