extension Request {
     ...
     */
    public static func clusterState(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func clusterState(metric: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func clusterState(metric: [String], index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
