extension Request {
     ...
     */
    public static func snapshotCreateRepository(repository: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func snapshotCreateRepository(repository: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/_snapshot/\(repository)"
