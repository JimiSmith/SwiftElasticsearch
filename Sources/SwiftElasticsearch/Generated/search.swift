extension Request {
     ...
     */
    public static func search(method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func search(method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/_search"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func search(index: [String], method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func search(index: [String], method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index.joined(separator: ","))/_search"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func search(index: [String], type: [String], method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func search(index: [String], type: [String], method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index.joined(separator: ","))/\(type.joined(separator: ","))/_search"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
