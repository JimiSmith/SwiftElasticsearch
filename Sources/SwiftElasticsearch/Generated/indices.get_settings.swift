extension Request {
     ...
     */
    public static func indices_get_settings(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_settings"
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_settings(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_settings(index: [String], name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_settings(name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
