extension Request {
     ...
     */
    public static func update_by_query(index: [String], method: HttpMethod = .POST, body: ElasticsearchBody?) -> Request {
        assert(method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func update_by_query(index: [String], method: HttpMethod = .POST, body: [String : Any]?) -> Request {
        assert(method == .POST)
        let url = "/\(index.joined(separator: ","))/_update_by_query"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func update_by_query(index: [String], type: [String], method: HttpMethod = .POST, body: ElasticsearchBody?) -> Request {
        assert(method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func update_by_query(index: [String], type: [String], method: HttpMethod = .POST, body: [String : Any]?) -> Request {
        assert(method == .POST)
        let url = "/\(index.joined(separator: ","))/\(type.joined(separator: ","))/_update_by_query"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
