extension Request {
     ...
     */
    public static func indices_put_settings(method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
        assert(method == .PUT)
        let url = "/_settings"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indices_put_settings(method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT)
        let url = "/_settings"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indices_put_settings(index: [String], method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
        assert(method == .PUT)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indices_put_settings(index: [String], method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT)
        let url = "/\(index.joined(separator: ","))/_settings"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
