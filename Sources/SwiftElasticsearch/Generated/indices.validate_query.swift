extension Request {
     ...
     */
    public static func indicesValidateQuery(method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesValidateQuery(method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/_validate/query"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesValidateQuery(index: [String], method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesValidateQuery(index: [String], method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index.joined(separator: ","))/_validate/query"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesValidateQuery(index: [String], type: [String], method: HttpMethod = .GET, body: ElasticsearchBody?) -> Request {
        assert(method == .GET || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesValidateQuery(index: [String], type: [String], method: HttpMethod = .GET, body: [String : Any]?) -> Request {
        assert(method == .GET || method == .POST)
        let url = "/\(index.joined(separator: ","))/\(type.joined(separator: ","))/_validate/query"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
