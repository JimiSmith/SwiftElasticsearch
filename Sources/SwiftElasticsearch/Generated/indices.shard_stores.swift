extension Request {
     ...
     */
    public static func indices_shard_stores(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_shard_stores(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
