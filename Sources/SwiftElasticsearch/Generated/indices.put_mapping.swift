extension Request {
     ...
     */
    public static func indicesPutMapping(index: [String], type: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutMapping(index: [String], type: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/\(index.joined(separator: ","))/_mapping/\(type)"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutMapping(type: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
        assert(method == .PUT || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutMapping(type: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/_mapping/\(type)"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
