extension Request {
     ...
     */
    public static func cluster_stats(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func cluster_stats(node_id: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_cluster/stats/nodes/\(node_id.joined(separator: ","))"
        return Request(method: method, url: url, body: nil)
    }
