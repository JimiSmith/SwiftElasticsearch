extension Request {
     ...
     */
    public static func indicesPutWarmer(name: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutWarmer(name: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/_warmer/\(name)"
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutWarmer(index: [String], name: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
        assert(method == .PUT || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutWarmer(index: [String], name: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/\(index.joined(separator: ","))/_warmer/\(name)"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutWarmer(index: [String], type: [String], name: String, method: HttpMethod = .PUT, body: ElasticsearchBody) -> Request {
        assert(method == .PUT || method == .POST)
     ...
     * - parameter body: The body to be sent with the request
     */
    public static func indicesPutWarmer(index: [String], type: [String], name: String, method: HttpMethod = .PUT, body: [String : Any]) -> Request {
        assert(method == .PUT || method == .POST)
        let url = "/\(index.joined(separator: ","))/\(type.joined(separator: ","))/_warmer/\(name)"
        return Request(method: (method == .GET ? .POST : method), url: url, body: body)
    }
