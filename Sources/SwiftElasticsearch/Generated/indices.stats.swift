extension Request {
     ...
     */
    public static func indicesStats(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_stats"
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesStats(metric: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesStats(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indicesStats(index: [String], metric: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
