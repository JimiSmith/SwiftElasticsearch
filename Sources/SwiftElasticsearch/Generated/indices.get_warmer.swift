extension Request {
     ...
     */
    public static func indices_get_warmer(method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
        let url = "/_warmer"
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_warmer(index: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_warmer(index: [String], name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_warmer(name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
     ...
     * - parameter method: The http method used to execute the request
     */
    public static func indices_get_warmer(index: [String], type: [String], name: [String], method: HttpMethod = .GET) -> Request {
        assert(method == .GET)
